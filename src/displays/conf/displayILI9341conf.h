...
const ScrollConfig metaConf       PROGMEM = {{ TFT_FRAMEWDT, TFT_FRAMEWDT, 2, WA_CENTER }, 140, true, MAX_WIDTH, 5000, 5, 30 };
...
const ScrollConfig weatherConf    PROGMEM = {{ 8, 120, 2, WA_LEFT }, 140, false, MAX_WIDTH, 0, 3, 30 };

/* BACKGROUNDS  */                       /* {{ left, top, fontsize, align }, width, height, outlined } */
const FillConfig   metaBGConf     PROGMEM = {{ 0, 0, 0, WA_LEFT }, DSP_WIDTH, 28, false };
const FillConfig   metaBGConfInv  PROGMEM = {{ 0, 27, 0, WA_LEFT }, DSP_WIDTH, 2, false };
const FillConfig   volbarConf     PROGMEM = {{ TFT_FRAMEWDT+40, 240+6, 0, WA_LEFT }, MAX_WIDTH-36, 6, true };
...
const WidgetConfig voltxtConf     PROGMEM = { TFT_FRAMEWDT+170, 216, 2, WA_LEFT };
const WidgetConfig  iptxtConf     PROGMEM = { TFT_FRAMEWDT+20, 224, 1, WA_LEFT };
const WidgetConfig   rssiConf     PROGMEM = { 4, 216, 2, WA_RIGHT };
...
const WidgetConfig  clockConf     PROGMEM = { 0, 200, 0, WA_RIGHT }; //
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT+24, 82, 1, WA_LEFT };
...
const MoveConfig   weatherMove    PROGMEM = { 8, 190, -1 };
const MoveConfig   weatherMoveVU  PROGMEM = { 8, 190, -1 };
